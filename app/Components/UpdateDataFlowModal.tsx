...
export default function UpdateDataFlowModal(props: IProps) {
  const { isEdit, setIsEdit, selectedCompanyId, setIsCompleted } = props;
    ...
    if (e.target.files && e.target.files[0]) {
      ...
      try {
        ...
        await documentApi.create({
          company_id: selectedCompanyId, // Replace with dynamic value if needed
              ...
              >
                ...
                <div className="flex items-center justify-around mt-6">
                  <button
                    ...
                    className="px-6 py-2 lg:py-[18px] lg:px-[80px] rounded-lg border border-[#D99A70] text-[#D99A70] text-2xl leading-[34px] cursor-pointer font-semibold h-auto"
                  >
                    Cancel
                  </button>
                  <button
